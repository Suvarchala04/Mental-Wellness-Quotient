    ...
    <div id="teacher-image">
        <div className="container text-center">
            ...
            <div className="row">
                ...
                <div className="col-md-4 col-sm-12"><br /><br />
                    <h1 className="dash" id="Teacher-Dashboard">Dashboard</h1>
                </div>
                <div className="col-md-4 col-sm-12"></div>
            </div>
            <br />
            <div className="row">
                ...
                <div className="col-md-6 col-sm-12 Dashboard-box"><br />
                    ...
                    <Link to="/Teacher" type="button" className="btn btn-light dash-quiz-btn">Start</Link>
                    <br /> <br />
